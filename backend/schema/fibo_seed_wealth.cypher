// FIBO Wealth Management Seed Dataset: High-Net-Worth Individuals & Asset Portfolios
// Formatted with explicit MATCH / MERGE patterns for robust relational integrity
...
// 3. Client 1: Victoria Sterling (Ultra-HNW)
...
// 4. Client 2: Marcus Thorne (HNW, Conservative Preservation)
